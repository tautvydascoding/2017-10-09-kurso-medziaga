        ...
        <main class="row">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    ...
                                    <div class="pagrindinis-pavadinimas baltas-fontas idealus-centravimas">
                    ...
                    <div class="row" id="eile-istorija">
                        ...
                        <article class="col-md-6 text-left">
                                <p class="baltas-fontas pagrindinis-tekstas">
                                    Manoma, kad Neringos teritorijoje pirmieji gyventojai atsikėlė maždaug prieš 4000 metų. Ten kur plačia šakota delta pasibaigia Nemunas, tyvuliuoja Kuršių marios, nuo jūros atitvertos balto smėlio pylimu – nerija.
                                    Padavimai pasakoja, kad čia buvusi mitinio kunigaikščio Videvučio pilis. Nerija – jauniausia Lietuvos pajūrio sausuma. Prieš 5–6 tūkstančius metų jos čia visai nebuvo, tik kur ne kur virš vandens kyšojo salų viršūnės
                                    – klostėsi povandeninė sekluma... </p>
            ...
            <section class="pilnas-plotis">
                <div class="row" id="eile-lankytinos-vietos">
                    ...
                    <article class="col-sm-12 col-md-6 krastovaizdis-tekstas">
                        <h4 class="antrasciu-tekstas">kraštovaizdis</h4>
                        <p class="pagrindinis-tekstas">Tūkstančiai keliautojų kasmet keliasi per Klaipėdos perkėlą į Kuršių Nerijos pusiasalį, pailsėti nuo kasdienių problemų, bei atgauti jėgas unikaliosios parko gamtos apsuptyje. Neringos grožis yra vertinamas tiek Lietuvos,
                            tiek ir užsienio turistų. įspūdingoji Kuršių Nerijos gamta atsiskleidžia fotografų darbuose:</p>
                ...
                <div class="row" id="eile-lankytoju-patirtis">
                    <section class="carousel slide" data-ride="carousel" id="postsCarousel">
                        ...
                        <div class=" p-t-0 m-t-2 carousel-inner">
                            <div class="row row-equal carousel-item active m-t-0 margin-sides-15px">
                                <div class="col-md-3">
                                    <div class="card korta">
                                        ...
                                        <div class="card-block p-t-2">
                                            ...
                                            <div class="card-footer kortu-footer">
                                                <a data-toggle="modal" href="#patirtis-isplesta" class="card-link" id="istorija1-daugiau">
                                                    <p class="text-left antrasciu-tekstas" straipsnioID = "<?php echo $istorija['id']?>">DAUGIAU</p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row row-equal carousel-item m-t-0 margin-sides-15px">
                                <div class="col-md-3">
                                    <div class="card korta">
                                        <div class="card-img-top card-img-top-250">
                ...
                <div class="row" id="eile-lankytoju-patirtis-responsive">
                    <section class="carousel slide" data-ride="carousel" id="postsCarousel">
                        <div class=" p-t-0 m-t-2 carousel-inner">
                            <div class="row row-equal carousel-item active m-t-0">
                                <div class="col-sm-12 col-korta">
                                    <div class="card korta">
                                        <div class="card-img-top card-img-top-250">
                                            <img class="img-fluid" src="./images/<?php $istorija = getIstorija(1); echo $istorija['photo']?>" alt="Nida svyturys prieplauka">
                                        </div>
                            ...
                            <div class="row row-equal carousel-item m-t-0">
                                <div class="col-sm-12 col-korta fadeIn wow">
                                    <div class="card korta">
                                        <div class="card-img-top card-img-top-250">
                                            <img class="img-fluid" src="./images/<?php $istorija = getIstorija(8); echo $istorija['photo']?>" alt="neringa">
                                        </div>
                ...
                <div class="row" id="eile-ikelti-istorija">
                    ...
                    <div class="col-md-6 text-left mygtukai-prev-next">
                ...
                <div class="modal fade" id="patirtis-isplesta" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="lankytojo-vardas"></h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <img src="" alt="Kursiu Nerija" id="foto-padidinta">
                                <p id="straipsnis-padidintas"></p>
                            </div>
