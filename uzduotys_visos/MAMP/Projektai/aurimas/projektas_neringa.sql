...
--
-- Host: localhost:8889
-- Generation Time: Nov 06, 2017 at 09:39 AM
...
CREATE TABLE `lankytoju_komentarai` (
  `id` int(6) NOT NULL,
...
--
-- Indexes for table `lankytoju_komentarai`
--
ALTER TABLE `lankytoju_komentarai`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `istorijos`
--
ALTER TABLE `istorijos`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `lankytoju_komentarai`
--
ALTER TABLE `lankytoju_komentarai`
